...
namespace SCH
{
     ...
     */
    void CTSP2_scheduler(const CTSP::instance &I, 
                         const SYNC_LIB::sync_solution &initial_feasible_solution, 
                         SCH::output_streams &output_streams_instance);
    
    /**
     * @brief Generate schedule for CTSP1 (single-depot) problem
     * @param I CTSP instance
     * @param initial_feasible_solution Feasible CTSP solution
     * @param output_streams_instance Output streams for schedule file
     * @note Similar to CTSP2_scheduler but for single-depot variant
     */
    void CTSP1_scheduler(const CTSP::instance &I, 
                         const SYNC_LIB::sync_solution &initial_feasible_solution, 
                         SCH::output_streams &output_streams_instance);
     ...
     */
    typedef void (*scheduler_ptr)(const CTSP::instance &I, 
