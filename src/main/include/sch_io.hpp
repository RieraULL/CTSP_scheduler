...
namespace SCH
{
    ...
    public:
        ...
        string out_file; ///< Path to solution file (.sol format)

        /**
         * @brief Constructor with file paths
         * @param _ins_file Path to instance file
         * @param _fea_file Path to solution file
         */
    ...
    /**
     * @brief Set file paths for CTSP2 problem
     * @param instance_name Instance identifier
     * @param os_instance Output streams container
     * @param input_files_instance Input files container
     * @note Helper function for programmatic file setup
     */
    void set_files_ctsp2(const string &instance_name, SCH::output_streams &os_instance, SCH::input_files &input_files_instance);
